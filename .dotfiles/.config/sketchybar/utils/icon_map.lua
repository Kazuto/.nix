-- Icon mapping utility for application icons
-- Converted from shell script to Lua for front_app item

local icon_map = {}

-- Application icon mapping table
local app_icons = {
  ["Live"] = ":ableton:",
...
-- Function to get icon for application name
function icon_map.get_icon(app_name)
  ...
  -- Pattern matching for apps with version numbers or wildcards
  for pattern, icon_result in pairs(app_icons) do
    if string.find(app_name, pattern, 1, true) then
      return icon_result
    end
  end
